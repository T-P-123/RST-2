...
\phantomsection
\addcontentsline{toc}{section}{\protect\numberline{\thesection}Příklad 1E -- Stochastické vyhodnocení vnitřních účinků nosníku}%
\markboth{Příklad 1E -- Stochastické vyhodnocení vnitřních účinků nosníku}{}%

\newgeometry{left=18mm,right=18mm,top=16mm,bottom=18mm}
\begingroup
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.92\textwidth,height=0.32\textheight,keepaspectratio]{p1_zadani.png}
...
\section*{Stochastické vyhodnocení}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.82\textwidth,height=0.30\textheight,keepaspectratio]{p1_01_deterministicke_prubehy.png}
...
\begin{figure}[H]
	...
	\begin{minipage}[t]{0.49\textwidth}
		\centering
		\includegraphics[width=\textwidth,height=0.30\textheight,keepaspectratio]{p1_02_stochasticky_prubeh_T.png}
		{\small (a) Posouvající síla \(T(x)\)}
	\end{minipage}
	\hfill
	\begin{minipage}[t]{0.49\textwidth}
		\centering
		\includegraphics[width=\textwidth,height=0.30\textheight,keepaspectratio]{p1_03_stochasticky_prubeh_M.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.92\textwidth,height=0.32\textheight,keepaspectratio]{p1_04_histogram_max_abs_M.png}
