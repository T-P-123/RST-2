...
\phantomsection
\addcontentsline{toc}{section}{\protect\numberline{\thesection}Příklad 3E -- Výpočet pravděpodobnosti bezporuchového provozu (klínové řemeny)}%
\markboth{Příklad 3E -- Výpočet pravděpodobnosti bezporuchového provozu (klínové řemeny)}{}%
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{p3_qq_grafy.png}
...
\section*{Výpočet indexu spolehlivosti}
...
\section*{Výpočet pravděpodobnosti}
